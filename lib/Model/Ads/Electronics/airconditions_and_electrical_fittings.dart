...
class AirConditionsAndElectricalFittingsPostModel extends BasePostModel {
  int? type;
  int? brand;
  String? subImages1;
  String? subImages2;
  ...
  AirConditionsAndElectricalFittingsPostModel({
    super.catId,
    super.subcatId,
    super.userId,
  ...
  factory AirConditionsAndElectricalFittingsPostModel.fromJson(Map<String, dynamic> json) {
    return AirConditionsAndElectricalFittingsPostModel(
      catId: json['catId'],
