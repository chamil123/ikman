...
class AudioAndMP3PostModel extends BasePostModel {
  int? type;
  int? brand;
  String? subImages1;
  String? subImages2;
  ...
  factory AudioAndMP3PostModel.fromJson(Map<String, dynamic> json) {
    return AudioAndMP3PostModel(
      catId: json['catId'],
