...
class CamerasAndCamcorderPostModel extends BasePostModel {
  int? type;
  int? brand;
  String? subImages1;
  String? subImages2;
  ...
  factory CamerasAndCamcorderPostModel.fromJson(Map<String, dynamic> json) {
    return CamerasAndCamcorderPostModel(
      catId: json['catId'],
