...
class ComputerAndTabletPostModel extends BasePostModel {
  int? type;
  int? brand;
  String? subImages1;
  String? subImages2;
  ...
  factory ComputerAndTabletPostModel.fromJson(Map<String, dynamic> json) {
    return ComputerAndTabletPostModel(
      catId: json['catId'],
