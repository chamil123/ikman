...
class MobilePhoneAccessoryPostModel extends BasePostModel {
  int? type;
  int? brand;
  String? subImages1;
  String? subImages2;
  ...
  factory MobilePhoneAccessoryPostModel.fromJson(Map<String, dynamic> json) {
    return MobilePhoneAccessoryPostModel(
      catId: json['catId'],
