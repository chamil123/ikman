...
class OtherElectronicPostModel extends BasePostModel {
  int? type;
  int? brand;
  String? subImages1;
  String? subImages2;
  ...
  factory OtherElectronicPostModel.fromJson(Map<String, dynamic> json) {
    return OtherElectronicPostModel(
      catId: json['catId'],
