...
class TvAndVideoAccessoryPostModel extends BasePostModel {
  int? type;
  String? subImages1;
  String? subImages2;
  String? subImages3;
  ...
  factory TvAndVideoAccessoryPostModel.fromJson(Map<String, dynamic> json) {
    return TvAndVideoAccessoryPostModel(
      catId: json['catId'],
