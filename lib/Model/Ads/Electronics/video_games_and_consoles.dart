...
class VideoGamesAndConsolesPostModel extends BasePostModel {
  int? type;
  int? brand;
  String? subImages1;
  String? subImages2;
  ...
  VideoGamesAndConsolesPostModel({
    super.catId,
    super.subcatId,
    super.userId,
  ...
  factory VideoGamesAndConsolesPostModel.fromJson(Map<String, dynamic> json) {
    return VideoGamesAndConsolesPostModel(
      catId: json['catId'],
