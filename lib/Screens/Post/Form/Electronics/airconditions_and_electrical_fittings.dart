...
class AirConditionsAndElectricalFittingsAdForm extends BaseAdForm {
  AirConditionsAndElectricalFittingsAdForm(
      {Key? key, required void Function(Map<String, dynamic>) onSave})
      : super(key: key, onSave: onSave);

  @override
  AirConditionsAndElectricalFittingsAdFormState createState() => AirConditionsAndElectricalFittingsAdFormState();
...
class AirConditionsAndElectricalFittingsAdFormState extends BaseAdFormState {}
