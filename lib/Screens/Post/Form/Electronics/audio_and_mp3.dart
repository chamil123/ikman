...
class AudioAndMP3AdForm extends BaseAdForm {
  AudioAndMP3AdForm(
      {Key? key, required void Function(Map<String, dynamic>) onSave})
      : super(key: key, onSave: onSave);

  @override
  AudioAndMP3AdFormState createState() => AudioAndMP3AdFormState();
...
class AudioAndMP3AdFormState extends BaseAdFormState {}
