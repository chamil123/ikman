...
class CamerasAndCamcordersAdForm extends BaseAdForm {
  CamerasAndCamcordersAdForm(
      {Key? key, required void Function(Map<String, dynamic>) onSave})
      : super(key: key, onSave: onSave);

  @override
  CamerasAndCamcordersAdFormState createState() => CamerasAndCamcordersAdFormState();
...
class CamerasAndCamcordersAdFormState extends BaseAdFormState {}
