...
class ComputerAndTabletsAdForm extends BaseAdForm {
  ComputerAndTabletsAdForm(
      {Key? key, required void Function(Map<String, dynamic>) onSave})
      : super(key: key, onSave: onSave);

  @override
  ComputerAndTabletsAdFormState createState() => ComputerAndTabletsAdFormState();
...
class ComputerAndTabletsAdFormState extends BaseAdFormState {}
