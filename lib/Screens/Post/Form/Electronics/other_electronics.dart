...
class OtherElectronicsAdForm extends BaseAdForm {
  OtherElectronicsAdForm(
      {Key? key, required void Function(Map<String, dynamic>) onSave})
      : super(key: key, onSave: onSave);

  @override
  OtherElectronicsAdFormState createState() => OtherElectronicsAdFormState();
...
class OtherElectronicsAdFormState extends BaseAdFormState {}
