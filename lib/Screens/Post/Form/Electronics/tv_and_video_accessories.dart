...
class TvAndVideoAccessoriesAdForm extends BaseAdForm {
  TvAndVideoAccessoriesAdForm(
      {Key? key, required void Function(Map<String, dynamic>) onSave})
      : super(key: key, onSave: onSave);

  @override
  TvAndVideoAccessoriesAdFormState createState() => TvAndVideoAccessoriesAdFormState();
...
class TvAndVideoAccessoriesAdFormState extends BaseAdFormState {}
