...
class VideoGamesAndConsolesAdForm extends BaseAdForm {
  VideoGamesAndConsolesAdForm(
      {Key? key, required void Function(Map<String, dynamic>) onSave})
      : super(key: key, onSave: onSave);

  @override
  VideoGamesAndConsolesAdFormState createState() => VideoGamesAndConsolesAdFormState();
...
class VideoGamesAndConsolesAdFormState extends BaseAdFormState {}
